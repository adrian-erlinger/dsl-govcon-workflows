# Public SAM.gov Practice Reference Prompt

Use this after completing the synthetic first run and when you want to practice against a real public SAM.gov opportunity. It is the detailed reference version of the starter prompt.
